package com.odea.behavior.onlyDoubleBehavior;
...
public class OnlyDoubleBehavior extends Behavior {

	private static final long serialVersionUID = 1L;

	@Override
	public void bind(Component component) {
		component.add(new AttributeAppender("onkeypress", "return isNumberDotCommaKey(event);"));
	}

    String jQuerySelector;

    public OnlyDoubleBehavior(String id){
	...
	public void afterRender(Component component) {
        ...
        PackageTextTemplate packageTextTemplate = new PackageTextTemplate(getClass(), "onlydoublebehavior.js", "text/javascript");
